...
const BestNewsPage = () => {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        const ids = await fetchShowNewsIds();  // Fetch Show HN story IDs
...
// Function to fetch the list of Show HN Story IDs
async function fetchShowNewsIds() {
