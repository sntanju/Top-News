              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    By <Link href={`/user/${item.by}`} className="mx-1 underline decoration-orange-500">{item.by}</Link>
                    | <Link href={`/newses/${item.id}`} className="mx-1 underline decoration-orange-500">{item.descendants || 0} comments</Link>
